...
public:
    ...
    inline sc_time( const sc_time& );


    // assignment operator

    inline sc_time& operator = ( const sc_time& );


    // conversion functions

    inline sc_dt::uint64 value() const;      // relative to the time resolution
    inline double to_double() const;  // relative to the time resolution
    ...
    inline bool operator == ( const sc_time& ) const;
    inline bool operator != ( const sc_time& ) const;
    inline bool operator <  ( const sc_time& ) const;
    inline bool operator <= ( const sc_time& ) const;
    inline bool operator >  ( const sc_time& ) const;
    ...
    inline sc_time& operator *= ( double );
    inline sc_time& operator /= ( double );
...
#ifndef Synopsys_Win32
    friend const sc_time & min ( const sc_time&, const sc_time& );
    friend const sc_time & max ( const sc_time&, const sc_time& );
#endif
...
inline
const sc_time &
min ( const sc_time& a, const sc_time& b )
{
    return  a < b ? a : b;
}
...
inline
const sc_time &
max ( const sc_time& a, const sc_time& b )
{
    return  a > b ? a : b;
}
#endif
