...
typedef const char* (*T_scobj2name_fn_const)(const sc_core::sc_object*);
extern T_scobj2name_fn_const C_sc_snps_GetFullName_const;
...
public:
    ...
    const char* name() const
        { 
	  if (C_sc_snps_GetFullName_const) {
	    const char *tname = C_sc_snps_GetFullName_const(this);
