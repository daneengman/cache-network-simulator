...
template< class T, sc_writer_policy POL /* = SNPS_SC_WRITER_POLICY */ >  /*snps-changed*/
class sc_signal
...
public: // constructors and destructor:
    ...
    virtual sc_writer_policy get_writer_policy() const
        {
            /*snps-changed*/
            return (POL != SNPS_SC_WRITER_POLICY ?
                    POL : snps_sc_writer_policy_check::get_writer_policy());
        }
