...
/*vcs-changed*/
#define SC_API_VERSION_STRING snps_vcs_sc_api_version_j_2015_09

#define SYSTEMC_VERSION       20120701
#define SC_VERSION_ORIGINATOR "SNPS-VG"
...
#define SC_COPYRIGHT "        Copyright (c) 1996-2012 by Synopsys, Inc.,\n        ALL RIGHTS RESERVED\n"
...
//
// Macro to recognize that we have a VcsSystemC simulator
//
#define VCS_SYSTEMC
