...
SC_DEFINE_MESSAGE( SC_ID_RVM_SC_VAR_USAGE_, 150,
		        "incorrect use of rvm_sc_var" )
SC_DEFINE_MESSAGE( SC_ID_RVM_SC_VAR_NI_, 151,
                        "feature not implemented for rvm_sc_var" )
SC_DEFINE_MESSAGE( SC_ID_RVM_SC_EVENT_USAGE_, 152,
                        "incorrect use of rvm_sc_event" )
SC_DEFINE_MESSAGE( SC_ID_RVM_SC_EVENT_NI_, 153,
                        "feature not implemented for rvm_sc_event" )
SC_DEFINE_MESSAGE( SC_ID_RVM_SC_SIG_USAGE_, 154,
                        "incorrect use of rvm_sc_sig" )
SC_DEFINE_MESSAGE( SC_ID_RVM_SC_SIG_NI_, 155,
                        "feature not implemented for rvm_sc_sig" )
