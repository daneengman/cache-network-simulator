...
# DVE full session
# Saved on Sun May 5 19:08:31 2024
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{1786 31} {3704 1030}}
...
gui_sg_addsignal -group "$_session_group_2" { cadss_interconnect.interconnect.packetNodeRec cadss_interconnect.interconnect.packetSendNext cadss_interconnect.interconnect.packetOut cadss_interconnect.interconnect.packetSendIn cadss_interconnect.interconnect.packetCoreIn cadss_interconnect.interconnect.full cadss_interconnect.interconnect.clk cadss_interconnect.interconnect.rst_l cadss_interconnect.interconnect.packetRecieved cadss_interconnect.interconnect.packetIn cadss_interconnect.interconnect.recieved cadss_interconnect.interconnect.recievedOut }
...
gui_wv_zoom_timerange -id ${Wave.1} 22613 23505
...
gui_list_set_insertion_bar  -id ${Wave.1} -group interconnect  -position in

gui_marker_move -id ${Wave.1} {C1} 23060
