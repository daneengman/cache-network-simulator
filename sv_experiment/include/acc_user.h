...
/****************************************************************************
AIX platform uses 'global' method as in
file: /usr/vacpp/include/xlocale
...
extern DLL_IMPORT int acc_error_flag;
...
EXTERN int     acc_append_delays PROTO_PARAMS((handle object, ...));
EXTERN int     acc_append_pulsere PROTO_PARAMS((handle object, double val1r, double val1x, ...));
...
EXTERN int     acc_compare_handles PROTO_PARAMS((handle h1, handle h2));
EXTERN int     acc_configure PROTO_PARAMS((int item, char *value));
...
EXTERN int     acc_fetch_delays PROTO_PARAMS((handle object, ...));
...
EXTERN int     acc_fetch_pulsere PROTO_PARAMS((handle path_p, double *val1r, double *val1e, ...));
...
EXTERN int     acc_davinci_fetch_sym PROTO_PARAMS((handle object_handle));
EXTERN void    acc_davinci_print_sym PROTO_PARAMS((int ssim_handle));
...
EXTERN int     acc_initialize PROTO_PARAMS((void));
...
EXTERN int     acc_object_of_type PROTO_PARAMS((handle object, int type));
EXTERN int     acc_object_in_typelist PROTO_PARAMS((handle object, int *type_list));
...
EXTERN int     acc_replace_delays PROTO_PARAMS((handle object, ...));
EXTERN int     acc_replace_pulsere PROTO_PARAMS((handle object, double val1r, double val1x, ...));
EXTERN void    acc_reset_buffer PROTO_PARAMS((void));
EXTERN int     acc_set_interactive_scope PROTO_PARAMS((handle scope, int callback_flag));
EXTERN int     acc_set_pulsere PROTO_PARAMS((handle path_p, double val1r, double val1e));
...
EXTERN char   *acc_decompile PROTO_PARAMS((handle handleObj));
