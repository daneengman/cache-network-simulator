...
# DVE full session
# Saved on Sat May 4 17:36:45 2024
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{78 75} {1719 1045}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 105} {height 856} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 857
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 332} {height 856} {dock_state left} {dock_on_new_line true} {child_data_colvariable 169} {child_data_colvalue 100} {child_data_coltype 86} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
set _session_group_8 divider
gui_sg_create "$_session_group_8"
set divider "$_session_group_8"

gui_sg_addsignal -group "$_session_group_8" { cadss_interconnect.divider.RATIO cadss_interconnect.divider.clk_in cadss_interconnect.divider.divided_clock cadss_interconnect.divider.rst_l cadss_interconnect.divider.count cadss_interconnect.divider.clk_out }
...
catch {gui_list_expand -id ${Hier.1} cadss_interconnect}
catch {gui_list_select -id ${Hier.1} {cadss_interconnect.divider}}
...
gui_list_show_data -id ${Data.1} {cadss_interconnect.divider}
