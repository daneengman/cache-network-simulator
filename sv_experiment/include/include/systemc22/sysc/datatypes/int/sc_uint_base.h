...
public:
    sc_uint_bitref_r( const sc_uint_bitref_r& init ) :
	 sc_value_base(), m_index(init.m_index), m_obj_p(init.m_obj_p)
	 {}
...
public:
    sc_uint_subref_r( const sc_uint_subref_r& init ) :
        sc_value_base(), m_left(init.m_left), m_obj_p(init.m_obj_p), m_right(init.m_right)
	{}
...
public:
	...
	: sc_value_base(), m_val( a.m_val ), m_len( a.m_len ), m_ulen( a.m_ulen )
	{}
