...
typedef void (*T_sc_snps_sc_fifo_update)(sc_core::sc_object*, int);
extern T_sc_snps_sc_fifo_update C_sc_snps_sc_fifo_update;
typedef void (*T_sc_snps_sc_fifo_register_print_helper)(sc_core::sc_object*, void*);
extern T_sc_snps_sc_fifo_register_print_helper C_sc_snps_sc_fifo_register_print_helper;
namespace sc_snps {
    enum cb_reason { UPDATE, STUCK_IN_READ, STUCK_IN_WRITE, RESIZE, BUFFER_RESIZE };
};
...
public:
    ...
    // Apply function fn(sc_object*) to all elements in *m_update_list_p
    void vcs_cbug_walk_over_update_list( void(*fn)(sc_core::sc_object*) ) const;
