...
# DVE full session
# Saved on Sun May 5 19:23:19 2024
# Designs open: 1
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/dengman/private/cache-network-simulator/cadssyuching/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{1855 191} {3772 913}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 105} {height 623} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 927
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 324} {height 623} {dock_state left} {dock_on_new_line true} {child_data_colvariable 169} {child_data_colvalue 100} {child_data_coltype 86} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
if { ![gui_is_db_opened -db {/afs/ece.cmu.edu/usr/dengman/private/cache-network-simulator/cadssyuching/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /afs/ece.cmu.edu/usr/dengman/private/cache-network-simulator/cadssyuching -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active NetworkPkg /afs/ece.cmu.edu/usr/dengman/private/cache-network-simulator/cadssyuching/central_sv_files/NetworkPkg.svg
