...
#define tf_logic_memory_node          110
#define TF_LOGIC_MEMORY_NODE          tf_logic_memory_node
#define tf_vector_memory_node         111
#define TF_VECTOR_MEMORY_NODE         tf_vector_memory_node
#define tf_vector_memory_2state_node  112
#define TF_VECTOR_MEMORY_2STATE_NODE  tf_vector_memory_2state_node
#define tf_logic_mda_node             113
#define TF_LOGIC_MDA_NODE             tf_logic_mda_node
#define tf_vector_mda_node            114
#define TF_VECTOR_MDA_NODE            tf_vector_mda_node
#define tf_vector_mda_2state_node     115
#define TF_VECTOR_MDA_2STATE_NODE     tf_vector_mda_2state_node

#define ISWORDLAYOUT_MEMTFNODE(x)         (x->node_type == tf_logic_memory_node || \
                                           x->node_type == tf_vector_memory_2state_node || \
                                           x->node_type == tf_vector_memory_node)

/*-------------- vcs save/restore status -------------*/

#define VCS_SAVERESTORE_NONE               -1 
#define VCS_SAVERESTORE_IN_SAVE            0 
#define VCS_SAVERESTORE_SAVE_FAILED        1 
#define VCS_SAVERESTORE_SAVE_SUCCESS       2 
#define VCS_SAVERESTORE_IN_RESTORE         3 
#define VCS_SAVERESTORE_RESTORE_FAILED     4 
#define VCS_SAVERESTORE_RESTORE_SUCCESS    5 
#define VCS_SAVERESTORE_RESTART            6 
...
typedef struct t_tfnodeinfo
{
    ...
    union {
        ...
        char *memoryval_p;
        char *logic_memoryval_p;
        unsigned int *vector_memoryval_2state_p;
        double *real_val_p;
    } node_value;
    char *node_symbol;
    int node_ngroups;
...
EXTERN int          tf_getlongsimtime PROTO_PARAMS((int *ht));
...
EXTERN void         tf_register_sigtstp PROTO_PARAMS((void (*func)(int)));
EXTERN void         tf_register_sigcont PROTO_PARAMS((void (*func)(int)));
EXTERN void         tf_register_sigsegv PROTO_PARAMS((void (*func)(int, void*, void*)));
EXTERN void         tf_register_processsave PROTO_PARAMS((void (*func)(int)));
EXTERN void         tf_register_processrestore PROTO_PARAMS((void (*func)(int)));
EXTERN void         tf_register_processpostsave PROTO_PARAMS((void (*func)(int)));
EXTERN void         tf_register_processrestart PROTO_PARAMS((void (*func)(int)));
...
/* retrieve C file descriptor from file descriptor or MCD obtained from $fopen */
EXTERN int          tf_get_c_fd PROTO_PARAMS((unsigned int verilog_fd));

/* Determine if SV or standard memory layout is in use */
EXTERN int          tf_is_sv_array_layout PROTO_PARAMS((void));
