...
#ifdef STD_VCS_VHPI
/*
#define vhpi_register_cb(pCbData, flags) vhpi_register_cb_std(pCbData, flags)
#define vhpi_get_value(objectHandle, pValue) vhpi_get_value_std(objectHandle, pValue)
*/
